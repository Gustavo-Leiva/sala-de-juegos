...
import { Pais } from '../modules/juegos/componentes/models/paises';
...
export class PreguntadosService {
  ...
  // Método para obtener los datos de los países
  ...
  obtenerPaisesEnEspañol(): Observable<string[]> {
    return this.http.get<Pais[]>(this.apiUrl).pipe(
      map((data: Pais[]) => 
        data.map((pais: Pais) => 
          this.traducirNombrePais(pais.translations?.spa?.common || pais.name.common)
        )
      )
    );
  }
